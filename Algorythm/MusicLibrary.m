...
- (instancetype)init {
    //initialize our superclass and assign it to self
    self = [super init];
    
    if (self) {
        //set up library array
        //NSArray *library = @[];
        //          library = @[playlist, playlist, playlist];
        //NSDictionary *playlist = {@"someKey";@"someValue"};
        //(library)array of (playlist) dictionarys keyValue coded info unique to each playlist.
        //(i.e each dictionary is a playlist
